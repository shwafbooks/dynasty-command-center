...
export const PROVIDER_REGISTRY_VERSION='provider-registry-v1.1';
...
export const PROVIDERS={
  ...
  statsguy:{id:'statsguy',family:'observed-trade-market',independenceGroup:'completed-trades',label:'Stats Guy Fantasy',signal:'market value derived from observed fantasy trades',allowed:true,notes:'Documented public API is Sleeper-ID keyed. Public displays must preserve provider attribution/terms requirements.'},
