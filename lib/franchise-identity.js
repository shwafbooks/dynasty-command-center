...
export function canonicalFranchise({manager,liveTeam,rosterId}={}){
 ...
 return row?{team:liveTeam||row.team,manager:manager||row.manager,canonicalTeam:row.team,canonicalManager:row.manager,liveTeam:liveTeam||null,rosterId:rosterId??null,identityStatus:'canonical'}:{team:liveTeam||null,manager:manager||null,canonicalTeam:null,canonicalManager:null,liveTeam:liveTeam||null,rosterId:rosterId??null,identityStatus:'live-unmapped'};
}