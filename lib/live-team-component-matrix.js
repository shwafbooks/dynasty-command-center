...
export async function buildLiveTeamComponentMatrix({leagueId,throughWeek}={}){
 ...
 const canonicalTeams=teams.map(t=>{const c=canonicalFranchise({manager:t.manager,liveTeam:t.team,rosterId:t.rosterId});return{...t,team:c.team,manager:c.manager,liveTeam:c.liveTeam,identityStatus:c.identityStatus};});
